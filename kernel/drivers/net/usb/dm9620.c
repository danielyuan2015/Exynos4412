...
//JJ3
	...
	dev->net->dev_addr[0] = MACADDR[0];
	dev->net->dev_addr[1] = MACADDR[1];
	dev->net->dev_addr[2] = MACADDR[2];
	dev->net->dev_addr[3] = MACADDR[3];
	dev->net->dev_addr[4] = MACADDR[4];
	dev->net->dev_addr[5] = MACADDR[5];
#if 1
  ...
  kfree (tmpwPtr2); 
	...
	__dm9620_set_mac_address(dev);   // struct usbnet *
