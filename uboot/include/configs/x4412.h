...
#define CONFIG_AUTO_COMPLETE         /*auto complete*/
...
#define CONFIG_BOOTARGS		"lcd=vs070cxn tp=ft5x06-1024x600 cam=ov2655 mac=00:09:c0:ff:ee:58"
//#define CONFIG_NFSBOOTCOMMAND "lcd=vs070cxn tp=ft5x06-1024x600 cam=ov2655 mac=00:09:c0:ff:ee:58"
#define CONFIG_BOOTARGS_QT	"root=/dev/mmcblk0p2 rw rootfstype=ext4 lcd=vs070cxn tp=ft5x06-1024x600 cam=ov2655 mac=00:09:c0:ff:ee:58"
...
#define CONFIG_BOOTCOMMAND_QT	"movi read kernel 0 40008000;bootm 40008000"
...
#define CONFIG_SYS_MAXARGS	50//16	/* max number of command args */
...
#define CFG_PARTITION_START						(0x04000000)	/* 64MB */
