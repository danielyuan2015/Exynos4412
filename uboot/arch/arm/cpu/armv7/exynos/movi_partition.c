...
{	
	...
	/* image 8 should be 'ubootpak'(bootloader) */
	image[8].start_blk = location;

	image[8].used_blk = 1024 * 1024 / 512;
	image[8].size = 1024 * 1024 / 512;
	image[8].attribute = 0x1f;
	strcpy(image[8].description, "ubootpak");
	dbg("ubootpak: %d\n", image[8].start_blk);
